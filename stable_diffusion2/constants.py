...
class ModelsPathTree:
    ...
    def __init__(self, base_directory: str = "./"):
        ...
        self.root_models_path = os.path.abspath(os.path.join(base_directory, 'input/model/'))
        self.checkpoint_path = os.path.abspath(os.path.join(self.root_models_path, 'v1-5-pruned-emaonly.ckpt'))
        self.embedder_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_text_embedder/clip_embedder.ckpt'))
        self.tokenizer_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_text_embedder/clip_tokenizer.ckpt'))
        self.transformer_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_text_embedder/clip_transformer.ckpt'))
        # self.embedder_submodels_paths = {"tokenizer_path": self.tokenizer_path, "transformer_path": self.transformer_path}
        self.image_encoder_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_image_encoder/clip_image_encoder.ckpt'))
        self.clip_model_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_image_encoder/clip_model.ckpt'))
        self.image_processor_path = os.path.abspath(os.path.join(self.root_models_path, 'clip_image_encoder/image_processor.ckpt'))
        # self.image_encoder_submodels_paths = {"clip_model_path": self.clip_model_path, "image_processor_path": self.image_processor_path}
        self.unet_path = os.path.abspath(os.path.join(self.root_models_path, 'unet/unet.ckpt'))
        self.autoencoder_path = os.path.abspath(os.path.join(self.root_models_path, 'autoencoder/autoencoder.ckpt'))
        self.encoder_path = os.path.abspath(os.path.join(self.root_models_path, 'autoencoder/encoder.ckpt'))
        self.decoder_path = os.path.abspath(os.path.join(self.root_models_path, 'autoencoder/decoder.ckpt'))
        # self.autoencoder_submodels_paths = {"encoder_path": self.encoder_path, "decoder_path": self.decoder_path}
        self.latent_diffusion_path = os.path.abspath(os.path.join(self.root_models_path, 'latent_diffusion/latent_diffusion.ckpt'))
        # self.latent_diffusion_submodels_paths = {"embedder_path": self.embedder_path, "unet_path": self.unet_path, "autoencoder_path": self.autoencoder_path}
        # self.latent_diffusion_submodels_tree_paths = {
    ...
    def latent_diffusion_submodels(self):
        return {"embedder_path": self.embedder_path, "unet_path": self.unet_path, "autoencoder_path": self.autoencoder_path}
    @property
    ...
    def embedder_submodels(self):
        return {"tokenizer_path": self.tokenizer_path, "transformer_path": self.transformer_path}
    @property
    def image_encoder_submodels(self):
        return {"clip_model_path": self.clip_model_path, "image_processor_path": self.image_processor_path}
    @property
