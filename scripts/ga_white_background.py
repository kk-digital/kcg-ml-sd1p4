...
prompts_str_array = []
prefix_prompt = "isolated on white background, simple background, background chroma plain white, small black character, on white background, solid color background, on a white surface, tiny character, centered , small character, no background "
