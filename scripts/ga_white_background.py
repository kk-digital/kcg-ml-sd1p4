...
prompts_str_array = []
prefix_prompt = "isolated on white background, red apple, simple background, background chroma plain white, on white background, solid color background no white character, on a white surface, tiny character,  centered , small character"
