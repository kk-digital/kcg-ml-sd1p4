...
def calculate_fitness_score(ga_instance, solution, solution_idx):
    ...
    fitness_white = white_background_fitness(pil_image)
    fitness_pixel = fitness_pixel_value(pil_image)

    fitness_score = (fitness_white + fitness_pixel)
...
prompts_str_array = []
prefix_prompt = "isolated on white background, background chroma plain white, on white background, on a white surface, tiny character,  centered , small character, white background, no background,"
