...
class TestScripts(unittest.TestCase):
    ...
    def test_04_generate_images_from_embeddings(self):
        self.run_script(f"{self.scripts_path}generate_images_from_embeddings", num_seeds=4, temperature=1.2,
                        ddim_eta=0.2)

    def test_05_generate_images_from_distributions(self):
    ...
    def test_06_generate_images_from_temperature_range(self):
    ...
    def test_07_generate_images_and_encodings(self):
    ...
    def test_08_embed_prompts_and_generate_images(self):
        self.run_script(f"{self.scripts_path}embed_prompts_and_generate_images")

    def test_09_data_bounding_box_and_score_and_embedding_dataset(self):
