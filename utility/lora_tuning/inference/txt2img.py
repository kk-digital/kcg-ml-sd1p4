...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, required=True,
                        help="Path to the base Stable Diffusion checkpoint file.")
    ...
    parser.add_argument("--sampler", type=str, choices=['euler', 'dpm', 'lms', 'ddim'], default="dpm",
                        help="Sampler to use when generating the image")
