...
manifest_json_keys_to_check = ["file-name", "file-hash", "file-path", "file-archive", "image-type", "image-width",
                               "image-height", "image-size"]
features_json_keys_to_check = ["file-name", "file-hash", "file-path", "file-archive", "feature-type", "feature-model",
                               "feature-vector"]
