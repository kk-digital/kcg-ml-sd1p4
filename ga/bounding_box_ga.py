...
sd.quick_initialize().load_autoencoder(*config.get_model(SDconfigs.AUTOENCODER, to_dict=True)).load_decoder(
    *config.get_model(SDconfigs.DECODER))
...
num_phrases = 7
prompts_array = ga.generate_prompts(population_size, num_phrases)
