...
def generate_images_from_temp_range(
    ...
    dest_path = os.path.join(output_dir, f"t{TEMPERATURE_RANGE[0]:.3f}t{TEMPERATURE_RANGE[1]:.3f}_vs_{DIST_NAME}_p{PARAMS_RANGE[0]:.3f}p{PARAMS_RANGE[1]:.3f}.jpg")
...
def main():
    ...
    generate_images_from_temp_range(DISTRIBUTIONS, txt2img, 
